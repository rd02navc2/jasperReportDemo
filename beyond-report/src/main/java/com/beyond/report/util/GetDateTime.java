...
public class GetDateTime {
	...
	public static String[] getTimeA2() {
	    ...
	    String _sHour = String.format("%02d", date.get(Calendar.HOUR_OF_DAY)); // 24小時制的小時 (00-23)
	    String _sMin  = String.format("%02d", date.get(Calendar.MINUTE));      // 分鐘 (00-59)
	    String _sSec  = String.format("%02d", date.get(Calendar.SECOND));      // 秒數 (00-59)
	    
	    // 回傳 [小時, 分鐘, 秒] 陣列
	    return new String[] { _sHour, _sMin, _sSec };
	}

...
@Entity
@Table(name = "Rakuten_Order_Detail_Product")
@IdClass(RAKUTEN_ORDER_DETAIL_PRODUCT_ComposeKey.class)
public class RAKUTEN_ORDER_DETAIL_PRODUCT {
    ...
    @Id
    @Column(name = "c_no", length = 32, nullable = false)
    private String c_no;
...
class RAKUTEN_ORDER_DETAIL_PRODUCT_ComposeKey implements Serializable {
	private static final long serialVersionUID = 1L;
	private String transaction_id;
	private String order_id;
	private String ProductId;
	...
	public boolean equals(Object obj) {
		if (obj instanceof RAKUTEN_ORDER_DETAIL_PRODUCT_ComposeKey) {
			final RAKUTEN_ORDER_DETAIL_PRODUCT_ComposeKey other = (RAKUTEN_ORDER_DETAIL_PRODUCT_ComposeKey) obj;

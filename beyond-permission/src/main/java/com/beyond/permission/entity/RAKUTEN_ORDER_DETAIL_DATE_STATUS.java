...
@Entity
@Table(name = "Rakuten_Order_Detail_Date_Status")
@IdClass(RAKUTEN_ORDER_DETAIL_DATE_STATUS_ComposeKey.class)
public class RAKUTEN_ORDER_DETAIL_DATE_STATUS {
...
class RAKUTEN_ORDER_DETAIL_DATE_STATUS_ComposeKey implements Serializable {
	private static final long serialVersionUID = 1L;
	private String transaction_id;
	private String order_id;
	...
	public boolean equals(Object obj) {
		if (obj instanceof RAKUTEN_ORDER_DETAIL_DATE_STATUS_ComposeKey) {
			final RAKUTEN_ORDER_DETAIL_DATE_STATUS_ComposeKey other = (RAKUTEN_ORDER_DETAIL_DATE_STATUS_ComposeKey) obj;

...
@IdClass(ORDER_MASTER_ComposeKey.class)
...
class ORDER_MASTER_ComposeKey implements Serializable {
	private static final long serialVersionUID = 1L;
	private String transaction_id;
	private String order_id;
	...
	public boolean equals(Object obj) {
		if (obj instanceof ORDER_MASTER_ComposeKey) {
			final ORDER_MASTER_ComposeKey other = (ORDER_MASTER_ComposeKey) obj;

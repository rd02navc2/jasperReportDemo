...
import com.beyoung.surrounding.pos.bean.RefundBean;
import com.beyoung.surrounding.pos.client.PacePayFeignClient;
import com.beyoung.surrounding.pos.repository.PacePayRepository;
...
public class PacePayPosService {

    private final PacePayRepository pacePayRepository;  
    private final PacePayFeignClient pacePayFeignClient;
	...
	public PaceResponseBean pacepayPayment(String orderId, Integer amount) {
		...
		try {
			...
			PaceResponseBean paceResponseBean = pacePayFeignClient.pacepayPayment(requestBody); 
			...
			if (transactionId != null && !transactionId.isEmpty()) {
				...
				pacePayFeignClient.pacepayQuery(transactionId);
			}
	...
	public PaceResponseBean pacepayVerifyBarcode(String transactionId, String decryptedKey) {
		...
		try {
			...
			PaceResponseBean response = pacePayFeignClient.pacepayVerifyBarcode(transactionId, requestBody);
	...
	public PaceResponseBean pacePayRefund(String transactionId, Integer amount) throws Exception {
	        ...
	        PaceResponseBean paceResponseBean = pacePayFeignClient.refund(authHeader, refundBean);
    ...
    */
	...
	public PACE_TRANSACTION_LOG getTranLog(String orderId) {
	    List<PACE_TRANSACTION_LOG> list = pacePayRepository.findByOrderId(orderId);
	...
	public PaceResponseBean pacePayQuery(String transactionId) throws Exception {
        ...
        PaceResponseBean responseBean = pacePayFeignClient.pacepayQuery(transactionId);
	...
	public void updTranLogRefund(String orderId, String refundTranXId, Date timeZoneTransform, String invoiceNo) {
		...
		pacePayRepository.updTranLogRefund(orderId, refundTranXId, timeZoneTransform, invoiceNo);
	}

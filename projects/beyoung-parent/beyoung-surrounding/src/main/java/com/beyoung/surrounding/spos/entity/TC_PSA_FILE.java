...
public class TC_PSA_FILE implements Serializable {
    ...
    @Column(name = "TC_PSA14")  private String TC_PSA14;
    @Column(name = "TC_PSA15")  private String TC_PSA15;
    @Column(name = "TC_PSA16")  private String TC_PSA16;
    @Column(name = "TC_PSA17")  private String TC_PSA17;
    @Column(name = "TC_PSA18")  private String TC_PSA18;
    ...
    // --- 鼎新標準維護欄位 ---
    @Column(name = "TC_PSAUSER")  private String TC_PSAUSER;
    @Column(name = "TC_PSAMODU")  private String TC_PSAMODU;
    @Column(name = "TC_PSAGRUP")  private String TC_PSAGRUP;
    @Column(name = "TC_PSADate")  private String TC_PSADate;
    @Column(name = "TC_PSATIME")  private String TC_PSATIME;
    @Column(name = "TC_PSAORIG")  private String TC_PSAORIG;
    @Column(name = "TC_PSAORIU")  private String TC_PSAORIU;
    @Column(name = "TC_PSALEGAL") private String TC_PSALEGAL;

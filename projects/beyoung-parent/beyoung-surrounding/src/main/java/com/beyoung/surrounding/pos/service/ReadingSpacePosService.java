...
import com.beyoung.surrounding.pos.entity.READING_SPACE_LOG;
import com.beyoung.surrounding.pos.entity.READING_SPACE_PARAM;
import com.beyoung.surrounding.pos.repository.ReadingSpaceLogRepository;
import com.beyoung.surrounding.pos.repository.ReadingSpaceParamRepository;
import com.beyoung.surrounding.pos.repository.ReadingSpaceUnlimitRepository;
...
public class ReadingSpacePosService {

    private final MemberRepository memberRepository;
    private final ReadingSpaceLogRepository logRepository;
    private final ReadingSpaceUnlimitRepository unlimitRepository;
    private final ReadingSpaceParamRepository paramRepository;
    ...
    public ResponseBean purchase(
        ...
        List<READING_SPACE_LOG> logs =
                logRepository.findTodayLog(center, entity.getLpk01());
    ...
    public ResponseBean enter(String center, String cardNO, LPK_FILE entity) throws Exception {
        ...
        boolean isEmployee = unlimitRepository.existsByUserId(entity.getLpk01());
        ...
        if (!isEmployee) {
            ...
            // 載入系統參數
            List<READING_SPACE_PARAM> params = paramRepository.findByParamNameIn(Arrays.asList("member_limit", "minus_point"));
            ...
            // 判斷現場人數是否超額
            int currentPeopleCount = logRepository.countTodayInRoomPeople(center);
            ...
            List<READING_SPACE_LOG> todayLogs = logRepository.findTodayActiveLog(center, entity.getLpk01());
	...
	public ResponseBean refund(String center, String invoiceNO, String cardNO, String refundDate, LPK_FILE entity) {
		...
		List<READING_SPACE_LOG> logs = logRepository.findLogForRefund(center, refundDate, entity.getLpk01());

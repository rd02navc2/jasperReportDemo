...
public class LPK_FILE implements Serializable {
    ...
    // ==========================================
 // ==========================================
    //  @Transient 非持久化業務欄位 (修正處)
    // ==========================================
    @Column(name = "VIP_LEVEL") // 改成由 Column 映射，才能收 Native Query 的結果
    private Integer vipLevel;   // 保持 Integer

    @Transient
    private Double lsm081; 

    @Transient
    private Double lsm082; 

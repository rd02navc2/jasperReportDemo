...
import com.beyond.surrounding.pos2.entity.READING_SPACE_LOG_ComposeKey;

@Repository
public interface ReadingSpaceLogPos2Repository extends JpaRepository<READING_SPACE_LOG, READING_SPACE_LOG_ComposeKey>{

...
@Slf4j 
@RestController
@RequestMapping("/Surrounding/rest/pos2/OnePay")
@RequiredArgsConstructor
public class OnePayPos2Controller {
	...
	public ResponseBean purchase(
	        ...
	        @RequestParam String moPayType) throws JSONException {
	...
	public ONE_TRANSACTION_LOG query(
        ...
        try {
            ...
            ONE_TRANSACTION_LOG bean = new ONE_TRANSACTION_LOG();
            ...
            bean.setCode(ParseUtil.getTagValue(_sQueryStatus, "RtnPOSActionCode",    0));
            bean.setMessage(ParseUtil.getTagValue(_sQueryStatus, "RtnPOSActionCodeMsg", 0));
            bean.setTransTime(sdf.format(sdf1.parse(

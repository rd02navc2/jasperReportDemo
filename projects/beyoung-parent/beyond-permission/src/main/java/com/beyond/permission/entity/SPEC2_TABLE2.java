...
@Entity
@Table(name = "Spec2_Table2")
@IdClass(SPEC2_TABLE1_ComposeKey.class)
public class SPEC2_TABLE2 implements Serializable {
...
class SPEC2_TABLE2_ComposeKey implements Serializable {
	private static final long serialVersionUID = 1L;
	private String c_no;
	private String CustomizedMainProductId;
	private String SpecDimension;
	...
	public boolean equals(Object obj) {
		if (obj instanceof SPEC2_TABLE2_ComposeKey) {
			final SPEC2_TABLE2_ComposeKey other = (SPEC2_TABLE2_ComposeKey) obj;

...
@Entity
@Table(name = "BI_DAY_DEPT_REPORT")
@IdClass(BI_DAY_DEPT_REPORT_ComposeKey.class)
public class BI_DAY_DEPT_REPORT implements Serializable {
...
class BI_DAY_DEPT_REPORT_ComposeKey implements Serializable {
	private static final long serialVersionUID = 1L;
	private String report_date;
	private String floor;
	private String dept_no;
	...
	public boolean equals(Object obj) {
		if (obj instanceof BI_DAY_DEPT_REPORT_ComposeKey) {
			final BI_DAY_DEPT_REPORT_ComposeKey other = (BI_DAY_DEPT_REPORT_ComposeKey) obj;
			if (report_date == other.report_date && floor == other.floor && dept_no == other.dept_no)
				return true;
		}
		return false;
	}

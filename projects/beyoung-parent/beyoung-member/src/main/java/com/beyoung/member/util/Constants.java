package com.beyoung.member.util;

import java.util.regex.Pattern;

public class Constants {
	//public static final String BEYOND_WEB_SERVICE = "http://192.168.5.220:8080";
	public static int PARKING_STATUS = 2;
	
	public static String BEYONDPAY_UNSUPPORTED_CODE = "1234";
	public static String BEYONDPAY_UNSUPPORTED_MSG = "不支援此項電子支付";
	
	public static String BEYONDPAY_CODE_MISMATCH = "1235";
	public static String BEYONDPAY_CODE_MISMATCH_MSG = "電子支付對應錯誤";
	...
	// beyond code
	//public static final String BEYOND_BRANCH_ID = "BY170224";
	...
	//public static final int BEYOND_RECEIPT_POINT_STATE_SUCCESS = 2;
	...
	public static final String BEYOND_RECEIPT_POINT_USED_BY_POS = "0004"; //發票已被POS註記使用
	public static final String BEYOND_RECEIPT_POINT_EXPIRED = "0005";     //發票已過補登點數期限
	public static final String BEYOND_RECEIPT_POINT_USED_BY_ERP = "0006"; //發票已被ERP使用
	public static final String BEYOND_RECEIPT_POINT_INVALIDATE = "0007";  //無效發票
	public static final String BEYOND_RECEIPT_POINT_WITHDRAW = "0009";    //發票退貨
	
	

	
	
	public static final String BEYOND_RECEIPT_CAMPAIGN_UNAVAILABLE = "5001";   //沒有參加活動
	public static final String BEYOND_RECEIPT_CAMPAIGN_USED = "5002";          //發票已兌換
	public static final String BEYOND_RECEIPT_CAMPAIGN_NOT_START = "5003";     //活動尚未開始
	public static final String BEYOND_RECEIPT_CAMPAIGN_TIME_ERROR = "5008";     //發票時間錯誤
	public static final String BEYOND_RECEIPT_CAMPAIGN_WITHDRAW = "5007";     //活動退貨
	public static final String BEYOND_RECEIPT_CAMPAIGN_PARAMETER_ERROR = "9999"; //參數錯誤
	...
	public static final String BEYOND_RECEIPT_REDEEEM_USED = "5001";//發票重覆
	public static final String BEYOND_RECEIPT_REDEEEM_NOT_REACH_TARGET = "5002"; //發票未達兌換門檻
	public static final String BEYOND_RECEIPT_REDEEEM_NO_COUPON = "5003"; ////無可用電子券
	public static final String BEYOND_RECEIPT_REDEEEM_WITHDRAW = "5007"; ////退貨發票不可兌換
	public static final String BEYOND_RECEIPT_REDEEEM_OTHER_ERROR = "9998";  //其他錯誤
	public static final String BEYOND_RECEIPT_REDEEEM_PARAMETER_ERROR = "9999";  //參數錯誤
	
	//mercue define
	public static final String BEYOND_RECEIPT_REDEEEM_NO_RECEIPT = "1001"; ////無可用電子券
	public static final String BEYOND_RECEIPT_APP_USED = "1002"; ////發票已被app登錄

	public static final String BEYOND_RECEIPT_POINT_5_MINS = "1003";    //發票5分鐘同步問題
	
	
	public static final String BEYOND_DIRECT_ANSWER_PREFIX = "A";    //系統直接回覆前綴詞
	public static final String BEYOND_DIRECT_ANSWER = "1999";    //直接回覆系統訊息
